    ...
    <header class="header">
        <div class="header__container">
            ...
            <nav class="header__nav">
                ...
                <ul class="nav__list">
                    <li class="nav__list-item"><a href="productos.php">Productos</a></li>
            ...
            <div class="usuario-carrito">
                <div class="usuario">
                    <a href="../carrito/carrito.php"><button>👤</button></a> <!-- Icono del carrito -->
                </div>
                <div class="carrito">
                    <a href="../carrito/carrito.php"><button>🛒</button></a> <!-- Icono del carrito -->
                </div>
        ...
        <div class="container__producto">
            ...
            <?php while ($producto = $resultado->fetch_assoc()): ?>
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <!-- Imagen principal -->
                    <img src="../img/productos/<?php echo $producto['imagen_principal']; ?>"
                        class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?php echo substr($producto['descripcion'], 0, 90); ?>
                        </p>

                        <p><strong>$<?php echo number_format($producto['precio'], 0, ',', '.'); ?></strong></p>

                        <?php if ($producto['stock'] > 0) { ?>
                            <button class="btn btn-primary agregar-carrito" data-id="<?php echo $producto['id']; ?>">
                                Agregar al carrito
                            </button>
                        <?php } else { ?>

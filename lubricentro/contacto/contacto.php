...
<body>
    ...
    <main class="main">
        ...
        <div class="container__form">
            ...
            <form>
                <div class="mb-3">
                    <label for="exampleInputText" class="form-label" style="width: 300px;">Nombre</label>
                    <input type="text" class="form-control" id="exampleInputtext">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="width: 270px;">Email address</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>

                <div class="form-floating">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style=" width: 400px;height: 200px;"></textarea>
